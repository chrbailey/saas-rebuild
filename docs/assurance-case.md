...
| The export-compliance deterministic core is tested on Python 3.11–3.14 | 378 unit/adversarial tests, hash-seed rerun, end-to-end fixture screen, cross-run disposition comparison | Fixture coverage is not legal certification or proof against all name variants |
