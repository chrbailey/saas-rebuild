...
| Extraction recipes are structurally reviewable | Draft 2020-12 schema, 100-entry backlog checks, filename/index parity, HTTPS/date/uniqueness bibliography tests | v0.9 does not fetch sources, type their authority, map individual claims to sources, or prove a route in any tenant |
