...
The target index names 100 applications; at v0.11, 29 have schema-validated
...
- Extraction recipes are schema-checked against the 100-entry research
  ...
  v0.11 does not machine-map individual claims to sources or prove that a route
  works in a tenant.
...
interview statements that interview citations link to.

Existing users should read the [v0.10 → v0.11 migration guide](docs/migration-v0.11.md),
...
does not republish derived engagement material as part of the v0.11 evidence
base.
