...
The target index names 100 applications; at v0.12, 29 have schema-validated
...
- Extraction recipes are schema-checked against the 100-entry research
  ...
  v0.12 does not machine-map individual claims to sources or prove that a route
  works in a tenant.
...
Version 0.11 adds an optional `interviews.jsonl` of pseudonymous, consent-scoped
interview statements that interview citations link to. Version 0.12 lets Jev
suggest which feature an unlinked statement describes; only an analyst links it.

Existing users should read the [v0.11 → v0.12 migration guide](docs/migration-v0.12.md),
the [v0.10 → v0.11 migration guide](docs/migration-v0.11.md),
the [v0.9 → v0.10 migration guide](docs/migration-v0.10.md),
...
does not republish derived engagement material as part of the v0.12 evidence
base.
